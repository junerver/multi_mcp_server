...
TEMPLATE_FILES = {
    # 后端代码模板
    "domain": {
        "path": "java/domain.java.vm",
        "description": "Domain实体类模板",
        "category": "后端代码"
    },
    "mapper": {
        "path": "java/mapper.java.vm",
        "description": "Mapper接口模板",
        "category": "后端代码"
    },
    "service": {
        "path": "java/service.java.vm",
        "description": "Service接口模板",
        "category": "后端代码"
    },
    "serviceImpl": {
        "path": "java/serviceImpl.java.vm",
        "description": "Service实现类模板",
        "category": "后端代码"
    },
    "controller": {
        "path": "java/controller.java.vm",
        "description": "Controller控制器模板",
        "category": "后端代码"
    },
    "mapper_xml": {
        "path": "xml/mapper.xml.vm",
        "description": "MyBatis XML映射文件模板",
        "category": "后端代码"
    },
    "sub_domain": {
        "path": "java/sub-domain.java.vm",
        "description": "子表Domain实体类模板",
        "category": "后端代码"
    },
    # 前端代码模板
    "api": {
    ...
    "vue_index": {
        "path": "vue/index.vue.vm",
        "description": "Vue页面组件模板",
        "category": "前端代码"
    },
    "vue_form": {
        "path": "vue/v3/Form.vue.vm",
        "description": "Vue表单组件模板",
        "category": "前端代码"
    },
    "vue_tree": {
        "path": "vue/index-tree.vue.vm",
        "description": "Vue树形页面组件模板",
        "category": "前端代码"
    },
    "vue_v3_index": {
        "path": "vue/v3/index.vue.vm",
        "description": "Vue3页面组件模板",
        "category": "前端代码"
    },
    "vue_v3_tree": {
        "path": "vue/v3/index-tree.vue.vm",
...
@click.option("--port", type=int, default=3005, help="Port to listen on")
def main(transport: str, port: int):
    ...
    Args:
        ...
        port: 监听端口
    """
    logger.info(f"启动模板 MCP 服务器，传输类型: {transport}")
